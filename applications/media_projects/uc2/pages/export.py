"""UC2 — Export page: Video Intelligence (same report as UC1)."""
...
def render() -> None:
    ...
    stem = upload_data.get("filename", "video").rsplit(".", 1)[0]

    st.success("Your video intelligence report is ready.")

    col1, col2, col3 = st.columns(3)

    report_dict = {
        "source_video": upload_data.get("filename", ""),
