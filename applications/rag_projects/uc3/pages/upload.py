"""
UC3 — Upload Docs page.

Same document loading as UC1/UC2 — builds a ChromaDB vector store.
No BM25 index needed: the agent uses dense retrieval with query reformulation
to compensate for exact-term misses.
"""
...
def render() -> None:
    ...
    st.write(
        ...
        "The agent will decide when and how many times to search these documents — "
        "reformulating its query if the first retrieval isn't good enough."
    )
    ...
    with col_sample:
        with st.container(border=True):
            ...
            st.caption("3 ACME corporate policy documents — good for testing adaptive retrieval")
