"""CSV loading and validation for the loan eligibility workflow."""
...
DATAFRAME_SESSION_KEY = "loan_ml_dataframe"
DATASET_METADATA_SESSION_KEY = "loan_ml_dataset_metadata"
DATASET_FINGERPRINT_SESSION_KEY = "loan_ml_dataset_fingerprint"
