"""Upload page for the loan eligibility DL pipeline.

Reuses the loan_ml data_loader service (pure Python — no Streamlit imports),
but stores the result under loan_dl-specific session keys so both apps
