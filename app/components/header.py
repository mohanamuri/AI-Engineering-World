...
<div style="flex:1;"><div class="aiew-hero-title">AI Engineering <span class="aiew-gradient-word">World</span></div><div class="aiew-hero-copy">A hands-on portfolio of production-minded machine learning, deep learning, and generative AI systems — from data and experimentation to evaluation and deployment. Six progressive capability tiers, one real-world problem.</div><div class="aiew-chip-row"><span class="aiew-chip">🤖 Machine Learning</span><span class="aiew-chip">🧠 Deep Learning</span><span class="aiew-chip">🔍 Explainability</span><span class="aiew-chip">📄 RAG</span><span class="aiew-chip">🕵 AI Agent</span><span class="aiew-chip">⚙️ Multi-Agent</span></div></div>
