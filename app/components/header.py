...
<div style="flex:1;"><div class="aiew-hero-title">AI Engineering <span class="aiew-gradient-word">World</span></div><div class="aiew-hero-copy">Building production-grade AI systems—from Machine Learning and Deep Learning to Generative AI and Autonomous AI Agents.</div><div class="aiew-chip-row"><span class="aiew-chip">🤖 Machine Learning</span><span class="aiew-chip">🧠 Deep Learning</span><span class="aiew-chip">🔍 Explainability</span><span class="aiew-chip">📄 RAG</span><span class="aiew-chip">🕵 AI Agent</span><span class="aiew-chip">⚙️ Multi-Agent</span></div></div>
