...
<div class="aiew-chip-row"><span class="aiew-chip">🤖 ML · T1</span><span class="aiew-chip">🧠 Deep Learning · T2</span><span class="aiew-chip">🔍 XAI · T3</span><span class="aiew-chip">📄 RAG · T4</span><span class="aiew-chip">🕵 AI Agent · T5</span><span class="aiew-chip">⚙️ Multi-Agent · T6</span></div>
...
<div style="margin-left:auto;text-align:right;padding-left:1rem;"><div style="font-size:.62rem;font-weight:800;color:#34d399;letter-spacing:.08em;text-transform:uppercase;">● Live</div><div style="font-size:1.2rem;font-weight:760;color:#f1f5f9;letter-spacing:-.03em;">6 tiers</div><div style="font-size:.65rem;color:#94a3b8;">ready to explore</div></div>
</div>
</div>""",
